...
struct SavedCategory: Identifiable, Hashable {
  ...
  private static let known: [SavedCategory] = [
    ...
    .init(type: "Spa", title: "Spas", icon: "bubbles.and.sparkles.fill", artAssetName: "category-spa", isPlaceBased: true),
    .init(type: "Fitness", title: "Fitness", icon: "dumbbell.fill", artAssetName: "category-fitness", isPlaceBased: true),
    .init(type: "Concert", title: "Concerts", icon: "microphone.fill", artAssetName: "category-concert", isPlaceBased: true),
    .init(type: "Pop-up", title: "Pop-ups", icon: "box.truck.fill", artAssetName: "category-popup", isPlaceBased: true),
